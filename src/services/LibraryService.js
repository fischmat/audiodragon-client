...
export const libraryService = {
    ...
    async getItems(search, page = null, pageSize = 10, sortBy, sortOrder = {}, filters = []) {
        try {
            ...
            const response = await api.get(`v1/library?${_.join([searchParam, paginationParams, sortParams, filterParams], '&')}`);
